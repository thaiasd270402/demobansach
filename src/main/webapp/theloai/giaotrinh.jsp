				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="<%=url1 %>/img/giaotrinh/gt1.png"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Tư tưởng Hồ Chí Minh</a>
								</h4>
								<h5>50.000</h5>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="<%=url1 %>/img/giaotrinh/gt2.png"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Chủ nghĩa xã hội khoa học</a>
								</h4>
								<h5>60.000</h5>
								<p class="card-text">Giáo trình dành cho bậc đại học, cao đẳng</p>
							</div>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="<%=url1 %>/img/giaotrinh/gt4.png"
								alt="" ></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Toán cao cấp tập hai</a>
								</h4>
								<h5>45.000</h5>
								<p class="card-text">Giáo trình dành cho bậc đại học, cao đẳng</p>
							</div>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="<%=url1 %>/img/giaotrinh/gt5.png"
								alt="" ></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Toán cao cấp tập 3</a>
								</h4>
								<h5>40.000</h5>
								<p class="card-text">Giáo trình dành cho bậc đại học, cao đẳng</p>
							</div>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="<%=url1 %>/img/giaotrinh/gt6.png"
								alt="" ></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Giáo dục quốc phòng</a>
								</h4>
								<h5>80.000</h5>
								<p class="card-text">Giáo trình dành cho bậc đại học, cao đẳng</p>
							</div>
